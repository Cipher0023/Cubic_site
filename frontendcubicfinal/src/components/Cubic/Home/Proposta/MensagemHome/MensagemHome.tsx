...
export default function MensagemHome() {
  return (
    <div className="group relative w-full max-w-md">
      ...
      <section className="relative bg-gradient-to-br from-base-300 to-base-100 shadow-md p-5 border border-base-300 rounded-2xl w-full h-full">
        ...
        <form className="gap-6 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex justify-center md:col-span-2">
            <button type="submit" className="px-8 text-xl btn btn-info">
              Enviar
            </button>
          </div>
        </form>
